"""
Fixed Lambda bridge function - context variable issue resolved
"""
import json
import boto3
...
def lambda_handler(event, context):
    ...
    try:
        ...
        if function_name == 'getSecurityFindings':
            result = get_real_security_findings(parameters, context)
        elif function_name == 'checkSecurityServices':
            result = check_real_security_services(parameters, context)
        elif function_name == 'analyzeSecurityPosture':
            result = analyze_real_security_posture(parameters, context)
        else:
...
def get_real_security_findings(parameters, context):
...
def check_real_security_services(parameters, context):
...
def analyze_real_security_posture(parameters, context):
